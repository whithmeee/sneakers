  ...
  return (
    <div className={styles["cart-item"]}>
      <div className={styles["cart-info"]}>
        <p className={styles["info-title"]}>В корзине {items.length} товаров</p>
      ...
      {items.map((item) => (
        <div key={item.id} className={styles["cart-content"]}>
          ...
          <div className={styles["cart-title"]}>
            ...
            <p className={styles["cart-size"]}>Размер: {item.size}</p>
            <span>
            ...
            <div className={styles["cart-count"]}>
              <button>
                <CiCirclePlus onClick={() => handleIncrementCount(item.id)} />
              </button>
              <span>{item.count}</span>
              <button>
                <CiCircleMinus onClick={() => handleDecrementCount(item.id)} />
              </button>
            </div>
          </div>
